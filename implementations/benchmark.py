...
parser.add_argument('--bench_data_root', type=str, default='', help='root directory containing all the datasets')
...
parser.add_argument('--weights', type=str, default='', 
                    help='Path to foundation models path if DINO')
...
def predict_single_split(train_split, test_split, args, save_dir, dataset_name, model_name, device, bench_data_root, custom_encoder, extract_tiles):
    ...
    # if custom_encoder is not None and model_name == custom_encoder.name:
    if custom_encoder is not None and model_name == cli_args.model_name:
        encoder = custom_encoder
        args.overwrite = True 
    else:
